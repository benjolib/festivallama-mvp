...
- (void)setupView
{
    ...
    [self.actionButton setTitleColor:[UIColor globalOrangeColor] forState:UIControlStateNormal];
    [self.actionButton setTitleColor:[[UIColor globalOrangeColor] lighterColorWithAlpha:0.6] forState:UIControlStateHighlighted];

    self.separatorView.backgroundColor = [[UIColor lightGrayColor] lighterColorWithAlpha:0.6];
}
